        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PromptsCount = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MinPrice = table.Column<decimal>(type: "decimal(12,2)", precision: 12, scale: 2, nullable: true),
                    MaxPrice = table.Column<decimal>(type: "decimal(12,2)", precision: 12, scale: 2, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProExpiresAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    MaxPlaces = table.Column<int>(type: "int", nullable: false),
                    MaxPlans = table.Column<int>(type: "int", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PlaceId = table.Column<int>(type: "int", nullable: false),
                    UserId = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    QualityRating = table.Column<byte>(type: "tinyint", nullable: false),
                    ServiceRating = table.Column<byte>(type: "tinyint", nullable: false),
                    FoodReview = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    StaffReview = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PlanItems_Places_PlaceId",
                        column: x => x.PlaceId,
                        principalTable: "Places",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserListItems", x => new { x.ListId, x.PlaceId });
                    table.ForeignKey(
                        name: "FK_UserListItems_Places_PlaceId",
                        column: x => x.PlaceId,
                        principalTable: "Places",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_UserListItems_UserLists_ListId",
                        column: x => x.ListId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_FeedPosts_Events_EventId",
                        column: x => x.EventId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AiUsages_UserId_UsageDate",
                table: "AiUsages",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FeedPosts_EventId",
                table: "FeedPosts",
                column: "EventId");

            migrationBuilder.CreateIndex(
                name: "IX_PlaceAttributes_PlaceId",
